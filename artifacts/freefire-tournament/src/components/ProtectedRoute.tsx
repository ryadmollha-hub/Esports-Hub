...
function BannedScreen() {
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex flex-col items-center justify-center gap-4 px-3">
      ...
      <div className="text-center">
        <h1 className="text-2xl font-black uppercase text-white mb-1.5">
      ...
      <a href="/contact" className="px-4 py-2 border border-[#2a2a36] text-[#a0a0b0] rounded-lg hover:border-[#ff6b00]/40 hover:text-white transition-colors text-sm uppercase font-bold">
        Contact Support
      </a>
    </div>
  );
