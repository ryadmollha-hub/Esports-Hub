...
function FieldSeparator({
  ...
  return (
    <div
      ...
      className={cn(
        "relative -my-1.5 h-5 text-sm group-data-[variant=outline]/field-group:-mb-1.5",
        className
      )}
      {...props}
    >
      ...
      {children && (
        <span
          className="bg-background text-muted-foreground relative mx-auto block w-fit px-1.5"
