    ...
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-3 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-5">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#ff6b00]/10 border border-[#ff6b00]/30 rounded-full text-[#ff6b00] text-sm font-bold uppercase tracking-wider mb-3">
            <ShieldCheck className="w-4 h-4" />
            Admin Access Only
          </div>
          <h1 className="text-3xl font-black text-white uppercase">Admin <span className="text-[#ff6b00]">Login</span></h1>
          <p className="text-[#a0a0b0] mt-1.5 text-sm">Restricted area. Authorized personnel only.</p>
        </div>

        <div className="bg-[#12121a] border border-[#ff6b00]/20 rounded-2xl p-5 shadow-[0_0_40px_rgba(255,107,0,0.1)]">
          <form onSubmit={handleLogin} className="space-y-3.5">
            <div>
              <label className="block text-[#a0a0b0] text-xs uppercase tracking-wider mb-1.5">Admin Username</label>
            ...
            <div>
              <label className="block text-[#a0a0b0] text-xs uppercase tracking-wider mb-1.5">Password</label>
              <div className="relative">
            ...
            {error && (
              <div className="bg-[#ff2244]/10 border border-[#ff2244]/30 rounded-xl px-3 py-2.5 text-[#ff2244] text-sm">
                {error}
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-[#ff6b00] hover:bg-[#e66000] text-white font-black uppercase text-sm rounded-xl transition-all shadow-[0_0_20px_rgba(255,107,0,0.3)] hover:shadow-[0_0_30px_rgba(255,107,0,0.5)] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1.5"
            >
              {loading ? (
