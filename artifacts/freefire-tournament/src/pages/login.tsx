...
import { Flame, Eye, EyeOff, Mail, Lock, AlertCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-[#12121a] rounded-2xl border border-[#ff6b00]/20 p-8 shadow-[0_0_40px_rgba(255,107,0,0.08)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-right">
              <Link href="/forgot-password" className="text-xs text-[#ff6b00] hover:text-[#ff8533] transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center text-sm text-[#a0a0b0]">
            ...
            <Link href="/sign-up" className="text-[#ff6b00] font-bold hover:text-[#ff8533] transition-colors">
              Register now
            </Link>
          </div>
        </div>
        ...
        <div className="mt-4 text-center">
          <Link
            href="/admin-login"
            className="inline-flex items-center gap-1.5 text-xs text-[#606070] hover:text-[#a0a0b0] transition-colors"
          >
