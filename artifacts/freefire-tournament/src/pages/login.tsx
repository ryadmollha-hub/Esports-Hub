    ...
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="bg-[#12121a] rounded-2xl border border-[#ff6b00]/20 p-5 shadow-[0_0_30px_rgba(255,107,0,0.08)]">
          {error && (
            <div className="flex items-center gap-2 bg-[#ff2244]/10 border border-[#ff2244]/30 text-[#ff2244] rounded-xl px-3 py-2 mb-4 text-xs">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              <label className="block text-[#a0a0b0] text-xs uppercase tracking-wider font-bold mb-1.5">{t("login_email")}</label>
            ...
            <div>
              <label className="block text-[#a0a0b0] text-xs uppercase tracking-wider font-bold mb-1.5">{t("login_password")}</label>
              <div className="relative">
            ...
            <button type="submit" disabled={loading || !captcha}
              className="w-full py-2.5 bg-[#ff6b00] text-white font-black uppercase text-sm rounded-xl hover:bg-[#e66000] disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-[0_0_15px_rgba(255,107,0,0.3)] mt-1">
