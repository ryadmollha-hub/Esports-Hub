  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-3 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-lg mx-auto">
        ...
        <h1 className="text-4xl font-black uppercase text-white mb-2.5 leading-tight">
          Under <span className="text-[#ff6b00]">Maintenance</span>
        </h1>
        <p className="text-[#a0a0b0] text-lg mb-5 leading-relaxed">
          We're upgrading the arena for a better experience.<br />
          Please check back soon.
        </p>

        <div className="flex items-center justify-center gap-1.5 text-[#606070] text-sm mb-7">
        ...
        <a
          href="/admin-login"
          className="inline-flex items-center gap-1 text-xs text-[#404050] hover:text-[#a0a0b0] transition-colors"
        >
